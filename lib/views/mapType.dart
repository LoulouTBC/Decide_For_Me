...
class MapType extends StatefulWidget {
  var place;
  MapType({Key key, @required this.place}) : super(key: key);
...
class _MapTypeState extends State<MapType> {
  ...
  Future<List<dynamic>> sendQuestion() async {
    setState(() {});
    var response = await crud.postRequest(linkDoctorType, {
      "doctor_type": widget.place,
    });
        ...
        infoWindow: InfoWindow(
            ...
            onTap: () async {
              ...
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => Appoint(place: element.id)));
            }),
